              ...
              <div className="pure-form pure-form-aligned">
                <form className="pure-form pure-form-aligned" onSubmit={this.sendForm}>
                  <div className="pure-control-group">
                    ...
                    <input id="nome" type="text" name="name" value={this.state.name} onChange={this.setName}/>
                  </div>
                  <div className="pure-control-group">
                  ...
                  <div className="pure-control-group">
                    ...
                    <input id="senha" type="password" name="passw" value={this.state.passw} onChange={this.setPassw}/>
                  </div>
                  <div className="pure-control-group">
                    <label></label> 
